...
iface = gr.Interface(
    ...
    inputs=[
        ...
        Radio(
            choices=list(audio_type_mapping.keys()), label="Audio Type"
        ),  # Use the keys of the mapping as the choices
    ],
    outputs=[
    ...
    description="Enhance your audio using the Dolby API",
)
